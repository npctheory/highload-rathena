CREATE DATABASE IF NOT EXISTS rathena_web;

GRANT ALL ON `rathena_web`.* TO 'user'@'%';

CREATE USER IF NOT EXISTS 'rathena_web_user'@'%' IDENTIFIED WITH mysql_native_password BY 'password';

GRANT ALL PRIVILEGES ON `rathena_web`.* TO 'rathena_web_user'@'%';
