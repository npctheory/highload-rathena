...
GRANT ALL ON `rathena_logs`.* TO 'user'@'%';

CREATE USER IF NOT EXISTS 'rathena_logs_user'@'%' IDENTIFIED WITH mysql_native_password BY 'password';

GRANT ALL PRIVILEGES ON `rathena_logs`.* TO 'rathena_logs_user'@'%';
